...
Use `specifypro` or `spp` commands instead of `specify`.
...
# or
spp init <PROJECT_NAME>

# Or initialize in existing project
specifypro init . --ai claude
# or
spp init --here --ai claude
...
Want to see SpeckitPro in action? Check out our video overview!

[![SpeckitPro Video Overview](https://img.youtube.com/vi/H8osKk9ysng/maxresdefault.jpg)](https://youtu.be/H8osKk9ysng?si=rFFX4a8NDwN4kALH)
...
> **Note**: Use `specifypro` or `spp` commands instead of `specify` in this fork.
...
spp init <project_name> --ai claude
spp init . --ai claude
spp init --here --ai claude
spp init . --force --ai claude
```
...
# or
spp init <project_name> --ai claude --ignore-agent-tools
```
