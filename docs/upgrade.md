...
Once you've run `specifypro init`, the slash commands (like `/spp.specify`, `/spp.plan`, etc.) are **permanently installed** in your project's agent folder (`.claude/`, `.github/prompts/`, etc.). Your AI assistant reads these command files directly—no need to run `specifypro` again.
...
- **Test new slash commands:** Run `/spp.constitution` or another command to verify everything works
