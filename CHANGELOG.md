...
- Use the `/spp.` command prefix to easily discover SpeckitPro-related commands.
...
- All command files now prefixed with `spp.` (e.g., `spp.specify.md`, `spp.plan.md`) for better discoverability and differentiation in IDE/CLI command palettes and file explorers
